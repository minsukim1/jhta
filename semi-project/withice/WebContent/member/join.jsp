...
<div class="container" style="font-size: 13px;">
	<div class="row" style="padding: 10px 10px;">
		<div class="col-12">
 		...
 		<div class="row">
 			<div class="col-12">
 			<form id="user-form" method="post" action="register.jsp">
 				<div class="row">
 					<div class="col-12">
	 					<table class="table table-bordered">
	 						<tbody>
	 							<tr>
	 								<th style="width: 18%;">회원구분 <img src="../images/userimage/circle-16.png" width="5px;" height="5px;"/></th> 						
	 								<td><input type="radio" name="user-type" value="개인회원" checked="checked"/> 개인회원</td>
	 							</tr>
	 						</tbody>
	 					</table>
 					</div>
 				...
 				<div class="row">
 					<div class="col-12">	
 						<p style="text-align: right;"><img src="../images/userimage/circle-16.png" width="5px;" height="5px;"/> 필수입력사항</p>
 					</div>
 				</div>
 				<div class="row">
 					<div class="col-12">
 						<table class="table table-bordered">
 							<tbody>
 								<tr>
 									...
 									<td>
 										<input type="text" name="userid" onkeyup="valueCheckId()" id="userid" style="width:150px; height:30px; font-size:12px;"/> (영문소문자/숫자,4~16자)
 										<p id="message"></p>
 									</td>
 								</tr>
 								<tr>
 									...
 									<td>
 										<input type="password" name="pwd" id="pwd" onkeyup="valueCheckPassword()" style="width:150px; height:30px; font-size:12px;"/> (영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 10자~16자)
 										<p id="pwdmessage"></p>
 									</td>	
 								</tr>
 								<tr>
 								...
 								<tr>
 									...
 									<td>
 										<input type="text" name="username" id="username" style="width:150px; height:30px; font-size:12px;"/>
 									</td>
 								</tr>
 								<tr>
 								...
 								<tr>
		 							...
		 							<td><select name="tel1">
					 					...
					 					<input type="text" name="tel3" maxlength="4" style="width: 70px; height: 25px;"/>
					 				</td>
		 						</tr>
 								<tr>
			 						...
			 						<input type="text" name="cell2" id="cell2" maxlength="4" style="width: 50px; height: 25px;"/> -
			 						<input type="text" name="cell3" id="cell3" maxlength="4" style="width: 50px; height: 25px;"/>
			 						</td>
			 					</tr>
 								<tr>
			 						<th>SMS 수신여부 <img src="../images/userimage/circle-16.png" width="5px;" height="5px;"/></th>
			 						<td><input type="checkbox" name="sms" id="sms" value="Y"/> 동의함
			 					...
			 					<tr>
			 						...
			 						<td>
			 							<input type="text" name="email" id="email" onkeyup="valueCheckEmail()" style="width:150px; height:30px; font-size:12px;" />
			 							<p id="emailmessage"></p>
			 						</td>
			 					</tr>
 							</tbody>
				...
				<div class="row" style="padding: 10px 10px;">
 					...
 					<div class="col-12">
	 					<table class="table table-bordered">
	 						...
	 						<tr>
	 							...
	 							<td>
	 								<input type="text" name="birthyear" id="birthyear" maxlength="4" style="width:150px; height:30px; font-size:12px;"/> 년
	 								<input type="text" name="birthmonth" id="birthmonth" maxlength="2" style="width:150px; height:30px; font-size:12px;"/> 월
	 								<input type="text" name="birthday" id="birthday" maxlength="2" style="width:150px; height:30px; font-size:12px;"/> 일
	 							</td>
	 						</tr>
	 						<tr>
 				...
 				<div class="row">
 					<div class="col-6">
 						<h3>이용약관 동의</h3>
	 					<textarea name="agreearea" cols="70" rows="8" disabled="disabled">
	제1조(목적)
	이 약관은 재단법인 승일희망재단이 운영하는 위드아이스 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
	※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
	
	제2조(정의)
	① “몰”이란 재단법인 승일희망재단이 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
	② “이용자”란 “몰”에 접속하여 이 약관에 따라 “몰”이 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
	③ ‘회원’이라 함은 “몰”에 (삭제) 회원등록을 한 자로서, 계속적으로 “몰”이 제공하는 서비스를 이용할 수 있는 자를 말합니다.
	④ ‘비회원’이라 함은 회원에 가입하지 않고 “몰”이 제공하는 서비스를 이용하는 자를 말합니다.
	
	제3조 (약관 등의 명시와 설명 및 개정) 
	① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 위드아이스 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
	...
	부 칙(시행일) 이 약관은 2016년 4월 1일부터 시행합니다.</textarea>
	 					<p>이용약관에 동의하십니까?</p>
	 					<input type="checkbox" name="agreecheck" id="agreecheck" value="Y"/> 동의함
 					</div>
 					<div class="col-6">
 						<h3>개인정보 수집 및 이용 동의</h3>
 						<textarea name="privacyarea" cols="70" rows="8" disabled="disabled">
1. 개인정보 수집목적 및 이용목적
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
 						...
 						<input type="checkbox" name="privacycheck" id="privacycheck" value="Y"/> 동의함
 					</div>
 				</div>
 				<br />
 				<div class="row">
 					<div class="col-12 text-center">
 						<button class="btn btn-dark btn-lg" type="button" onclick="checkFieldValue()" >회원가입</button>
...
<script type="text/javascript">	
	function checkFieldValue() {		
		...
		var subaddress = document.getElementById("sample4_detailAddress").value;
		...
		var cell = document.getElementById("cell2").value;
		...
		for (i=0; i<agreecheck.length; i++) {
			...
			if (agreechecked) {
				...
				document.getElementsByName("agreecheck")[0].focus();
				return;
			}
		}
		
		var privacycheck = document.getElementsByName("privacycheck");
		var privacychecked = false;
		
		for (i=0; i<privacycheck.length; i++) {
			if (privacycheck[i].checked) {
				privacychecked = true;
			} else {
			...
			if (privacychecked) {
				...
				alert("개인정보 수집 및 이용에 동의에 체크해주세요.");
				document.getElementsByName("privacycheck")[0].focus();
				return;
			}
		}
	...
	function valueCheckId() {
		var userId = document.getElementById("userid").value;
		var el = document.getElementById("message");
		
		if (!userId.length) {
			el.textContent = "아이디를 입력해 주세요.";
			el.style.color = "red";
			return;
		}
		...
		if (!idReg.test(userId)) {
			el.textContent = "올바른 아이디가 아닙니다(4글자~16글자, 영어소문자/숫자로 구성)";
			el.style.color = "red";
			return;
		} 
		...
		xhr.onreadystatechange = function() {
			if (xhr.readyState == 4 && xhr.status == 200) {
				...
				var userId = JSON.parse(text);
				console.log(userId);
				if (userId["exist"] === true) {
					el.textContent = "중복된 아이디입니다.";
					el.style.color = "red";
				} else if (userId["exist"] == false) {
					el.textContent = "사용가능한 아이디입니다.";
					el.style.color = "green";
				}
			}
		}		
		xhr.open("GET", "duplicate.jsp?userid=" + userId);
