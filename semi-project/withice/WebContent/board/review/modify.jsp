...
<div class="container">
	...
	<!-- 입력폼을 포함하는 row 시작 -->
			...
			%>
	<div class="row">
		<h5 style="font-size: 16px; padding-left: 17px; padding-bottom: 7px; padding-top: 10px;">상품후기 수정</h5>
	</div>
	<hr>
	...
	<div class="row">
		<div class="col-12">
			...
			<div >
				...
				<div class="col-12">
					<!--문의하기 입력 폼 시작  -->
					<form id="update-review-form" method="post" action="update.jsp" enctype="multipart/form-data">
						...
						<div class="form-group row small" >
							<label class="col-2 col-form-label">SUBJECT</label>
								<input class="col-5" name="title" value="<%=review.getTitle() %>">
						</div>
						<div class="form-group row small">
							
							<div class="col-12">
								<textarea rows="20" class="form-control" name="content" style="font-size: 12px;"><%=review.getContent() %></textarea>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-12 text-right">
								...
								<div>
									<button  type="button" class="btn-sm btn btn-dark" onclick="checkValue()"><strong>수정</strong></button>
