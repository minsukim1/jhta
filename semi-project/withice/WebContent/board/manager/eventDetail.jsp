...
<body>
<%
	int managerBoardNo = NumberUtil.stringToInt(request.getParameter("eventno"));
	...
	ManagerBoard preManagerBoard = managerBoardDao.preView(managerBoardNo, managerBoard.getCateNo());
	ManagerBoard afterManagerBoard = managerBoardDao.afterView(managerBoardNo, managerBoard.getCateNo());
%>
<div class="container">
	<div class="row">
		<div class="col-12">
			<ul class="breadcrumb float-right">
				...
				<li class="breadcrumb-item"><a href="eventlist.jsp" style="color: black;">Event</a></li>
			</ul>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-12">
			<table class="table">
				...
				<tbody>
					...
					%>
					<tr>
						<td colspan="4" class="text-center"><img src="../../images/managerBoard/<%=managerBoard.getContent() %>" class="img-thumbnail" width="80%" height =100%/></td>
					</tr>
					<%
						}
					%>
...
%>
			<div>
				...
				<button type="button" class="btn-sm btn btn-secondary" data-toggle="modal" data-target="#eventBoard"><strong>수정</strong></button>
			</div>
<%
	}
%>
		...
		<!-- The Modal -->
		<div class="modal fade" id="eventBoard">
		     	...
		     	<div class="modal-content">
			        ...
			        <form method="post" action="updateEvent.jsp">
				        ...
				        <div class="modal-body">
				        	<input type="hidden" name="eventno" value="<%=managerBoard.getNo() %>" />
				        	<select class="form-control mb-3" name="eventstatus">
				        		<option value="2" selected="selected">이벤트 진행</option>
				        		<option value="3">이벤트 종료</option>
				        	</select>
		...
		<div class="col-12">
			<table class="table table table-lg border border-top-0 border-right-0 border-left-0" style="padding-bottom: 20px;">
				...
				<tr>
					...
					%>
						<td class="small"><a href="viewCount.jsp?eventno=<%=preManagerBoard.getNo()%>" style="color: black; text-decoration: none;" ><%=preManagerBoard.getTitle() %></a></td>
					<%
						} else {
					%>
				...
				<tr>
					...
					%>
						<td class="small"><a href="viewCount.jsp?eventno=<%=afterManagerBoard.getNo()%>" style="color: black; text-decoration: none;" ><%=afterManagerBoard.getTitle()%></a></td>
					<%
						} else {
					%>
