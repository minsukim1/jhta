...
<head>
  ...
  <style type="text/css">
  	div.row > div {background-color: lightgreen; border: 1px solid black;}
  </style>
</head>
<body>
<div class="container">
...
<!-- 
	부트스트랩의 그리드시스템
	* 모든 행(<div class="row"></div>)은 적절한 정렬과 패딩을 위해서 반드시
	  <div class="container">안에 위치해야한다.
	...
	* 하나의 행(<div class="row">)은 12개의 열을 가지고 있으며, 원하는 만큼 크기를 명시해서
	   나눌 수 있다.
