...
<div class="container">
	...
	<div class="row">
		<div class="col-12">
			...
			<div>
				<strong class="display-4">결제금액 : </strong> <span class="display-4">${price1*amount1 + price2*amount2 }</span>
			</div>
			<div>2인 구매시 각자 부담금액 : ${(price1*amount1 + price2*amount2)/2 }</div>
			<div>2인 구매시 각자 부담금액 : ${(price1*amount1 + price2*amount2) div 2 }</div>
		</div>
	</div>
</div>
</body>
