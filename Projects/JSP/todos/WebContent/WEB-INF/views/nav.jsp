	...
	<nav class="navbar navbar-expand-sm navbar-dark bg-dark mt-3 mb-3">
    	...
    	<c:choose>
    		<c:when test="${empty loginUser }">
      		<li class="nav-item">
        		<a class="nav-link" href="/register.hta" onclick="openRegisterformModal(event)"><fmt:message key="menu.label.signup" /></a>
      		</li>
      		<li class="nav-item">
        		<a class="nav-link" href="/login.hta" onclick="openLoginformModal(event)"><fmt:message key="menu.label.signin" /></a>
      		</li>
      		</c:when>
      		<c:otherwise>
      		<li class="nav-item">
