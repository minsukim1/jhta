...
<%
	...
	System.out.println("page1.jsp의 PageContext에 조회한 값 : " + pageContextValue);
	System.out.println("page1.jsp의 HttpServletRequest에 조회한 값 : " + requestValue);
	System.out.println("page1.jsp의 HttpSession에 조회한 값 : " + sessionValue);
	System.out.println("page1.jsp의 ServletContext에 조회한 값 : " + applicationValue);
	
	// page2.jsp를 재요청하는 응답을 브라우저로 보내기
