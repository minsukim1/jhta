...
public class BookDao {
	...
	public void insertBook(Book book) throws SQLException {
		String sql = "insert into sample_books(book_title, book_writer, book_publisher, book_genre, book_price, book_discount_price"
		...
		pstmt.setDouble(6, book.getDiscountPrice());
