...
public class Main {
	...
	public static void main(String[] args) {
		String conf = "kr/co/jhta/di/service/step5/context.xml";
		// GenericXmlApplicationContext 스프링 컨테이너 클래스다.
		// 스프링 컨테이너는 빈 설정파일을 로드해서 그 안에 정의된 모든 객체를 생성한다.
		// 객체들간의 의존관계를 조사해서 객체들을 조립한다.
		// 조립이 완료된 객체들을 보관/유지/관리한다.
		ApplicationContext ctx = new GenericXmlApplicationContext(conf);

		// 스프링 컨테이너가 보관중인 객체 꺼내기
