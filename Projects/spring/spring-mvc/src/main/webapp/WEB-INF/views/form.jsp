                ...
                <div class="card">
                    <form:form id="user-form" method="post" action="signup.do" modelAttribute="userForm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>이름</label>
                                <form:input type="text" path="name" class="form-control" id="user-name"/>
                                <form:errors path="name" cssClass="text-danger"></form:errors>
                            </div>
                            <div class="form-group">
                                <label>비밀번호</label>
                                <form:input type="password" path="password" class="form-control" id="user-password"/>
                                <form:errors path="password" cssClass="text-danger"></form:errors>
                            </div>
                            <div class="form-group">
                                <label>전화번호</label>
                                <form:input type="tel" path="tel" class="form-control" id="user-tel"/>
                                <form:errors path="tel" cssClass="text-danger"></form:errors>
                            </div>
                            <div class="form-group">
                                <label>이메일</label>
                                <form:input type="email" path="email" class="form-control" id="user-email"/>
                                <form:errors path="email" cssClass="text-danger"></form:errors>
                            </div>
                            <div class="form-group">
                                <label>나이</label>
                                <form:input type="number" path="age" class="form-control" id="user-age"/>
                                <form:errors path="age" cssClass="text-danger"></form:errors>
                            </div>
                            <div class="form-group">
                                <label>생년월일</label>
                                <form:input type="date" path="birth" class="form-control" id="user-birth"/>
