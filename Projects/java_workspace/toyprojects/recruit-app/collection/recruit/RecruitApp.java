...
public class RecruitApp {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (menuNo == 1) {
				System.out.println("==========================================================================");
				System.out.println("1.이력서등록 2.경력사항등록 3.채용상태확인 4.이력서수정 5.경력사항 수정 6.구직신청 삭제");
				System.out.println("==========================================================================");
				...
				if (empMenuNo == 1) {
					...
					System.out.print("구직신청번호를 입력하세요 : ");
					int recruitmentNo = scanner.nextInt();
					System.out.print("합격불합격여부를 입력하세요 : (Y/N)");
					String passed = scanner.next();
					if(!passed.equals("Y") && !passed.equals("N")) {
						System.out.println("알파벳이 일치하지 않습니다.");
						continue;
					}
					boolean isPassed = passed.equals("Y") ? true : false;
