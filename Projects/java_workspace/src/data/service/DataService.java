...
public class DataService {
	...
	public void printDataStat() {
		...
		System.out.println("최다 사고 발생 시도 : " + sidoMaxStat.getName() + ", " + sidoMaxStat.getRecords() + " "
				+ sidoMaxStat.getDeaths());
		System.out.println("최다 사고 발생 월 : " + monthMaxStat.getName() + ", " + monthMaxStat.getRecords() + " "
				+ monthMaxStat.getDeaths());
		System.out.println("최다 사고 발생 날짜 : " + dayMaxStat.getName() + ", " + dayMaxStat.getRecords() + " "
				+ dayMaxStat.getDeaths());
		System.out.println("최다 사고 발생 요일 : " + dayOfWeekMaxStat.getName() + ", " + dayOfWeekMaxStat.getRecords() + " "
				+ dayOfWeekMaxStat.getDeaths());
		System.out.println("최다 사고 발생 유형 : " + violationMaxStat.getName() + ", " + violationMaxStat.getRecords() + " "
				+ violationMaxStat.getDeaths());
