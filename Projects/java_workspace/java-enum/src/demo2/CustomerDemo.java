...
public class CustomerDemo {
	...
	public static void main(String[] args) {
		...
		// enum타입에서 정의한 상수값 외의 값은 대일될 수 없고,
		// 컴파일시에 에러가 발생한다.
//		Customer customer5 = new Custmoer("홍길동","골드");
//		Customer customer6 = new Custmoer("홍길동",0);
//		Customer customer7 = new Custmoer("홍길동",Grade.VVIP);
